...
with tab_combo:
    ...
    st.caption(
        "· 증시지수 콤보: 나스닥·다우존스(왼쪽 축, 선), 신규상장주 ETF(오른쪽 축, 선). "
        "지수와 ETF는 스케일이 달라 축을 나눠 표시합니다.\n\n"
        "· 일본 국채 금리는 **일본 재무성(財務省)이 매영업일 공표**하는 국채금리정보에서 "
        "직접 받아옵니다(10년물 1986년~, 30년물 1999년~). 10년물과 30년물의 간격이 "
        "벌어질수록 장기물에 요구하는 수익률이 높아진 것입니다.\n\n"
        "· 엔/달러 환율은 **숫자가 클수록 엔화 약세**입니다(예: 150 → 160 은 엔 약세).\n\n"
